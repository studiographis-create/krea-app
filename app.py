...
# Style CSS : Mesh gradient, Glassmorphism & Boutons de filtres corrigés
st.markdown("""
<style>
    ...
    /* Boutons généraux et pastilles de catégories */
...
# Barre de filtres par catégories d'origine (sous forme de Radio horizontal comme au début)
...
if selected_category == "Tous" and selected_source == "Toutes les sources" and not search_query.strip() and st.session_state.category_views:
...
# Footer centré avec logo Krea et copyright
st.markdown("""
